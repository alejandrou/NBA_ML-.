...
class PlayerOperations:
    ...
    def scrape_and_save_players_roster(self):
        DBManager.create_tables(Player)
        player_roster = self.scraper_roster.get_players_team_year_roster()
    ...
    def scrape_and_save_players_totals(self):
        DBManager.create_tables(PlayerStats)
        player_totals = self.scraper_totals.get_players_team_year_totals()
